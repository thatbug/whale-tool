...
import org.thatbug.whale.core.tool.utils.ImageUtil;
 ...
 *
 * @author qzl
 * @date 17:40 2019/9/19
 */
public class WhaleFileProxyFactory implements IFileProxy {
    ...
    public String[] path(File f, String dir) {
        ...
        return new String[]{WhaleFileUtil.formatUrl(uploadPath.toString()), WhaleFileUtil.formatUrl(virtualPath.toString())};
    }
