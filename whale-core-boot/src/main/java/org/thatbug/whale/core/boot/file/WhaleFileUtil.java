...
public class WhaleFileUtil {
     ...
     * @return BladeFile
     */
    public static WhaleFile getFile(MultipartFile file) {
     ...
     * @return BladeFile
     */
    public static WhaleFile getFile(MultipartFile file, String dir) {
     ...
     * @return BladeFile
     */
    public static WhaleFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
        return new WhaleFile(file, dir, path, virtualPath);
    }
     ...
     * @return BladeFile
     */
    public static List<WhaleFile> getFiles(List<MultipartFile> files) {
     ...
     * @return BladeFile
     */
    public static List<WhaleFile> getFiles(List<MultipartFile> files, String dir) {
     ...
     * @return BladeFile
     */
    public static List<WhaleFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
        List<WhaleFile> list = new ArrayList<>();
        for (MultipartFile file : files) {
            list.add(new WhaleFile(file, dir, path, virtualPath));
        }
        return list;
    }
