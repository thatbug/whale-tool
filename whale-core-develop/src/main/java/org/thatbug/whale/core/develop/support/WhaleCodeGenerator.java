package org.thatbug.whale.core.develop.support;
...
import org.thatbug.whale.core.develop.constant.DevelopConstant;
 ...
 *
 * @author qzl
 * @date 11:12 2019/9/18
 */
@Data
@Slf4j
public class WhaleCodeGenerator {
    /**
     * 代码所在系统
     */
     ...
     * 代码所在服务名
     */
    private String serviceName = "whale-service";
    /**
     * 代码生成的包名
     */
    private String packageName = "org.thatbug.whale.test";
    /**
     * 代码后端生成的地址
     */
    ...
    public void run() {
        ...
        if (hasSuperEntity) {
            strategy.setSuperEntityClass("org.thatbug.whale.core.mybatis.base.BaseEntity");
            strategy.setSuperEntityColumns(superEntityColumns);
            strategy.setSuperServiceClass("org.thatbug.whale.core.mybatis.base.BaseService");
            strategy.setSuperServiceImplClass("org.thatbug.whale.core.mybatis.base.BaseServiceImpl");
        } else {
            strategy.setSuperServiceClass("com.baomidou.mybatisplus.extension.service.IService");
            strategy.setSuperServiceImplClass("com.baomidou.mybatisplus.extension.service.impl.ServiceImpl");
        }
        // 自定义 controller 父类
        strategy.setSuperControllerClass("org.thatbug.whale.core.boot.ctrl.WhaleController");
