package org.thatbug.whale.core.oss;
...
import org.thatbug.whale.core.oss.model.WhaleFile;
import org.thatbug.whale.core.oss.model.OssFile;
...
public class QiniuTemplate {
    ...
    @SneakyThrows
    public WhaleFile putFile(String fileName, MultipartFile file) {
        return putFile(ossProperties.getBucketName(), fileName, file);
    }


    @SneakyThrows
    public WhaleFile putFile(String bucketName, String fileName, MultipartFile file) {
        return putFile(bucketName, fileName, file);
    }


    @SneakyThrows
    public WhaleFile putFile(String fileName, InputStream stream) {
        return putFile(ossProperties.getBucketName(), fileName, stream);
    }


    @SneakyThrows
    public WhaleFile putFile(String bucketName, String fileName, InputStream stream) {
        return put(bucketName, stream, fileName, false);
    }

    @SneakyThrows
    public WhaleFile put(String bucketName, InputStream stream, String key, boolean cover) {
